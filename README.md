...
<div align="center">
  ...
  <a href="https://ChisaTalk.github.io/ChisaTalkWeb"><img src="https://img.shields.io/badge/📖-用户指南-blue.svg" alt="User Guide"></a>
...
<div align="center">
  ...
  <h1>ChisaTalk - 智能助手应用</h1>
  <p>📱 <b>移动端首个功能完备的AI智能助手应用，完全独立运行，拥有强大的工具调用能力</b> 📱</p>
</div>

<div align="center">
  <div style="padding: 10px 0; text-align: center;">
    <img src="docs/assets/9f85b39450c8616909039b66d15a475a.jpg" width="22%" alt="ChisaTalk预览图1" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/88a7b7520e4628682a849cc00716c8de.jpg" width="22%" alt="ChisaTalk预览图2" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/9036f349c25888d357de5ce34580176d.jpg" width="22%" alt="ChisaTalk预览图3" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
    <img src="docs/assets/d12038f26df3f814b4e3ce967537f039.jpg" width="22%" alt="ChisaTalk预览图4" style="display: inline-block; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); margin: 0 3px; max-width: 220px;">
  </div>
</div>
...
**ChisaTalk** 是移动端首个功能完备的 AI 智能助手应用，完全独立运行于您的 Android 设备上（除API调用），拥有强大的**工具调用能力**、**深度搜索**、**工作流与自动化**、**智能记忆库**，并支持**人设定制**与**角色卡**等高度自定义功能，集成 **MNN/llama.cpp 本地模型**、**MCP/Skill 生态**与**多语言界面**。它不仅仅是聊天界面，更是与Android权限和各种工具深度融合的**全能助手**，内置**Ubuntu 24 环境**，提供前所未有的强大功能。
...
| 📥 **下载安装** | [Release页面](https://github.com/ChisaTalk/ChisaTalk/releases) 下载最新APK |
| 📖 **使用指南** | [完整文档](https://ChisaTalk.github.io/ChisaTalkWeb) 包含详细教程和示例 |

> **安全提示：** 为确保您的数据安全，请务必从官方 [Release页面](https://github.com/ChisaTalk/ChisaTalk/releases) 或 [官方网站](https://ChisaTalk.github.io/ChisaTalkWeb/) 下载本应用。通过未知渠道下载的安装包可能被恶意修改，从而导致隐私泄露或设备被监听。
...
• <b>插件、工作区与上下文增强</b>：支持通过配置编辑器调试和自动编写 ChisaTalk 插件，新增本地 HTTP 对话入口、工作区重命名与规则文件自动读取，并增强历史跳转、双向分页与上下文自动补充能力<br>
...
> 📝 **完整更新日志**：访问 [Releases 页面](https://github.com/ChisaTalk/ChisaTalk/releases) 查看每个版本的详细更新内容

---

## 👨‍💻 开源共创

欢迎加入 ChisaTalk 开源生态！我们欢迎各种贡献：第三方脚本、MCP插件、核心功能开发。
...
如果 ChisaTalk 对您有帮助，欢迎自愿支持项目持续开发与基础运营：
...
遇到问题或有建议？欢迎 [提交 Issue](https://github.com/ChisaTalk/ChisaTalk/issues)！
...
<div align="center">
  ...
  <p><b>🚀 帮助我们推广，让更多人了解 ChisaTalk 🚀</b></p>
