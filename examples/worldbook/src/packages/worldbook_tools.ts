/* METADATA
{
  ...
  "tools": [
    ...
    },
    {
      "name": "import_entries",
      "description": {
        "zh": "从世界书 JSON 文件或 JSON 内容导入条目。兼容 ChisaTalk、SillyTavern lorebook，以及角色卡内嵌 character_book。",
        "en": "Import entries from a world book JSON file or JSON content. Supports ChisaTalk, SillyTavern lorebooks, and embedded character_book formats."
      },
      "parameters": [
        {
          "name": "path",
