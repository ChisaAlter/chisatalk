...
export const REMOTE_CHISATALK_SETUP_EN_US: RemoteChisaTalkSetupI18n = {
  title: "Remote ChisaTalk Setup",
  subtitle: "Let the current ChisaTalk call another ChisaTalk device through the LAN HTTP API.",
  topBanner:
    "Enable External HTTP Chat on the target ChisaTalk device first, then paste the LAN URL and Bearer token from that screen here.",
  configCardTitle: "Connection Config",
  configCardSubtitle:
    "After saving, this ChisaTalk can forward chat requests to another ChisaTalk device. A full http://IP:port URL is recommended.",
  baseUrlLabel: "Remote ChisaTalk Base URL",
  ...
  errorBaseUrlRequired: "Please enter the remote ChisaTalk Base URL",
  errorTokenRequired: "Please enter the remote ChisaTalk Bearer token",
  ...
  exampleCardSubtitle:
    "Once enabled, the current ChisaTalk can forward work to another device. The main entry is remote_operit_chat.",
