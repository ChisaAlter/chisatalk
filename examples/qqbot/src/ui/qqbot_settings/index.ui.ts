...
function resolveText(): TextBundle {
  ...
  if (locale.startsWith("en")) {
    return {
      ...
      aiTimeoutHint: "Maximum wait time for ChisaTalk to generate a reply.",
      chatGroupLabel: "ChisaTalk chat group",
      ...
      listenerSwitchDesc: "Keep the QQ Gateway listener running when entering ChisaTalk.",
  ...
  return {
    ...
    aiTimeoutHint: "等待 ChisaTalk 生成回复的最长时间。",
    chatGroupLabel: "ChisaTalk 会话分组",
    ...
    listenerSwitchDesc: "进入 ChisaTalk 时按这个开关恢复 QQ Gateway 监听。",
