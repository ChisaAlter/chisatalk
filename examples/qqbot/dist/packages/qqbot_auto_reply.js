    ...
    "tools": [
        {
            ...
            "parameters": [
                ...
                {
                    "name": "ai_timeout_ms",
                    "description": { "zh": "等待 ChisaTalk 回复的超时毫秒数，默认 180000", "en": "Timeout in milliseconds while waiting for the ChisaTalk reply, default 180000" },
                    "type": "number",
                    "required": false
                },
                {
        ...
        },
        {
            ...
            "description": {
                "zh": "启动 QQ Bot 自动回复循环。它会轮询消息队列，自动调用 ChisaTalk，再把回复发回 QQ。",
