...
declare global {
    ...
    // Get persistent plugin config directory under /sdcard/Download/ChisaTalk/plugins/<id>
    ...
    const CHISATALK_DOWNLOAD_DIR: string;
    const CHISATALK_CLEAN_ON_EXIT_DIR: string;
