...
android {
    ...
    defaultConfig {
        applicationId = "com.chisatalk.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.0.0"
        ...
        val chisaTalkServerBaseUrl =
            providers.gradleProperty("CHISATALK_SERVER_BASE_URL").orNull
                ?: localProperties.getProperty("CHISATALK_SERVER_BASE_URL", "")
        buildConfigField("String", "CHISATALK_SERVER_BASE_URL", "\"$chisaTalkServerBaseUrl\"")
