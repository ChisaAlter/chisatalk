...
const rootDir = '/sdcard/Download/ChisaTalk/js_test_download_probe_' + Date.now();
ensureDir(rootDir);

const successCases = [
  {
    name: 'type_android.d.ts',
    url: 'https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main/examples/types/android.d.ts',
  },
  {
    name: 'type_core.d.ts',
    url: 'https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main/examples/types/core.d.ts',
  },
  {
    name: 'type_results.d.ts',
    url: 'https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main/examples/types/results.d.ts',
  },
];

const failureCase = {
  name: 'missing_file.d.ts',
  url: 'https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main/examples/types/__definitely_missing_file__.d.ts',
};
