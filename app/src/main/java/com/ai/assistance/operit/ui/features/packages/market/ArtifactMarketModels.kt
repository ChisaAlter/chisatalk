...
const val OPERIT_MARKET_OWNER = "ChisaTalk"
const val OPERIT_FORGE_REPO_NAME = "ChisaTalkForge"
...
enum class PublishArtifactType(
    ...
    SCRIPT(
        wireValue = "script",
        marketRepo = "ChisaTalkScriptMarket",
        releaseTagPrefix = "script",
        titleLabel = "Script",
        marketLabel = SCRIPT_MARKET_LABEL,
        marketLabelColor = "0e8a16",
        marketLabelDescription = "Published script artifacts managed by ChisaTalk."
    ),
    PACKAGE(
        wireValue = "package",
        marketRepo = "ChisaTalkPackageMarket",
        releaseTagPrefix = "package",
        titleLabel = "Package",
        marketLabel = PACKAGE_MARKET_LABEL,
        marketLabelColor = "1d76db",
        marketLabelDescription = "Published package artifacts managed by ChisaTalk."
    );
...
fun buildPublishReleaseDescriptor(
    ...
    return PublishReleaseDescriptor(
        ...
        releaseBody =
            buildString {
                appendLine("${descriptor.type.titleLabel} artifact published by ChisaTalkForge.")
                appendLine()
