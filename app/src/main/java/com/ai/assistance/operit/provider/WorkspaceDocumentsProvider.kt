 ...
 * 路径: /data/data/com.chisatalk.app/files/workspace
 */
class WorkspaceDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.chisatalk.app.documents.workspace"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "ChisaTalk Workspace")
