...
class MemoryDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.chisatalk.app.documents.memory"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "ChisaTalk Memory Library")
    ...
    private fun includeDocument(result: MatrixCursor, documentId: String) {
        when (val ref = parseDocumentId(documentId)) {
            is DocRef.Root -> {
                ...
                row.add(DocumentsContract.Document.COLUMN_DISPLAY_NAME, "ChisaTalk Memory")
