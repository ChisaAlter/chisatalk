...
class EnhancedAIService private constructor(private val context: Context) {
    ...
    private suspend fun getAvailableToolsForFunction(
        ...
        return try {
            ...
            val selectedTools = listOf(
                ToolPrompt(
                    name = "visit_web",
                    description = "访问网页或读取搜索结果链接。",
                ...
                ToolPrompt(
                    name = "read_file_part",
                    description = "按行读取用户提供或授权范围内的文本文件片段。",
                    parametersStructured = listOf(
                        ToolParameterSchema(
                            name = "path",
                            type = "string",
                ...
                ToolPrompt(
                    name = "read_file_full",
                    description = "完整读取用户提供或授权范围内的文本文件。",
                    parametersStructured = listOf(
                        ToolParameterSchema(
                            name = "path",
                            type = "string",
                ...
                ToolPrompt(
                    name = "query_memory",
                    description = "查询当前 ChisaTalk 记忆库。",
                    parametersStructured = listOf(
                        ToolParameterSchema(
                            name = "query",
                            type = "string",
            ...
            AppLogger.d(
                TAG,
                "ChisaTalk 基础工具已启用，提供 ${selectedTools.size} 个工具"
            )
            selectedTools
        } catch (e: Exception) {
