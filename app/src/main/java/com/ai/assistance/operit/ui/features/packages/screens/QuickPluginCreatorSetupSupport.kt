...
private const val SANDBOX_PACKAGE_DEV_INSTALL_SCRIPT_URL =
    "https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main/tools/sandboxpackage_dev_install_or_update.js"
private const val SANDBOX_PACKAGE_DEV_SCRIPT_RELATIVE_PATH =
    "Download/ChisaTalk/skills/SandboxPackage_DEV/scripts/install_or_update.js"
...
private fun downloadSandboxPackageDevInstallScript(): File {
    ...
    val connection =
        (URL(SANDBOX_PACKAGE_DEV_INSTALL_SCRIPT_URL).openConnection() as HttpURLConnection).apply {
            ...
            readTimeout = 30_000
            doInput = true
            setRequestProperty("User-Agent", "ChisaTalk-QuickPluginCreator/1.0")
        }
