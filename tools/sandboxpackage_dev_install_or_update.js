...
const SandboxPackageDevInstaller = (function () {
  ...
  const SKILL_ROOT = `/sdcard/Download/ChisaTalk/skills/${SKILL_NAME}`;
  ...
  const CDN_BASE = "https://cdn.jsdelivr.net/gh/ChisaTalk/ChisaTalk@main";
  ...
  async function run() {
    ...
    await makeDirectory("/sdcard/Download/ChisaTalk/skills");
