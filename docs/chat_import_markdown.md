...
本文档介绍 ChisaTalk 应用支持的新版 Markdown 格式聊天记录导入规范。

> **注意**：ChisaTalk 采用了简洁的基于 HTML 注释的解析模式。**每个 Markdown 文件对应一个独立的对话**。不再支持在单个文件中使用 `---` 分割多个对话。
...
ChisaTalk 支持通过 **Zip 压缩包** 来管理多个对话。
